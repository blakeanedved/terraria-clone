...
auto Shader::Bind() -> void { glUseProgram(this->programID); }

auto Shader::AddUniform(const std::string &uniformName) -> void {
...
auto Shader::SetUniform(const std::string &uniformName, GLuint value) -> void {
    if (auto it = this->uniforms.find(uniformName);
        it != this->uniforms.end()) {
...
auto Shader::SetUniform(const std::string &uniformName, glm::mat4 value)
    -> void {
    if (auto it = this->uniforms.find(uniformName);
        it != this->uniforms.end()) {
...
auto Shader::SetUniform(const std::string &uniformName, glm::vec4 value)
    -> void {
    if (auto it = this->uniforms.find(uniformName);
        it != this->uniforms.end()) {
...
auto Shader::LoadShaders(const char *vertex_file_path,
